...
def generate_id():
    ...
    # Email is no longer required, so it's removed
    ...
    try:
        ...
        # Prepare the new record - Email field removed
        new_record = {
            'ID': generated_id,
            'Phone': phone,
        ...
        with open(DATA_FILE, mode='a', newline='', encoding='utf-8') as file:
            # fieldnames updated - 'Email' removed
            fieldnames = ['ID', 'Phone', 'Generated At', 'Generated By']
